...
{?>
					  			...
					  			<p><?php echo htmlentities($num1);?> permission not Process yet</p>
                  		</div>
                      <?php }?>
...
{?>
                  ...
                  <p><?php echo htmlentities($num1);?> permission Status in process</p>
                      </div>
  <?php }?>
...
{?>
                  ...
                  <p><?php echo htmlentities($num1);?>Permission has been closed</p>
                      </div>
