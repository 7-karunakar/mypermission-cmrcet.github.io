...
$complainno=$cmpn;
echo '<script> alert("Your complain has been successfully filled and your Permisson no is  "+"'.$complainno.'")</script>';
}
?>
...
<html lang="en">
  <head>
    ...
    <title>CMS | User Register Permission</title>
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Register Permission</h3>
...
<option value="">College activites</option>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">HOURS FOR PERSMISSION</label>
<div class="col-sm-4">
<select name="complaintype" class="form-control" required="">
                <option value="General Query">--select hours--</option>
                <option value=" 1 hour"> 1:00</option>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Nature of Permission</label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Permission Details (max 2000 words) </label>
<div class="col-sm-6">
<textarea  name="complaindetails" required="required" cols="10" rows="10" class="form-control" maxlength="2000"></textarea>
</div>
</div>
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Permission Related Doc(if any) </label>
<div class="col-sm-6">
