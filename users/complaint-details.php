...
<html lang="en">
  <head>
    ...
    <title>PMS | Permission Details</title>
...
<?php include('includes/sidebar.php');?>
      <section id="main-content" style="padding-left:5%; color:#000">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Permission Details</h3>
            <hr />
...
{?>
          	<div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Permission Number : </b></label>
          		<div class="col-sm-4">
...
<label class="col-sm-2 col-sm-2 control-label"><b>Sub Category :</b> </label>
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Hours :</b></label>
              <div class="col-sm-4">
...
<label class="col-sm-2 col-sm-2 control-label"><b>State :</b></label>
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Nature of Permission :</b></label>
              <div class="col-sm-4">
...
<?php } ?>
 ...
 <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Permission Details </label>
              <div class="col-sm-10">
